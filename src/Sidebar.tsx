...
import type { UserInfo } from "./gopad";
  ...
  return (
    ...
    >
      ...
      <Text fontSize="sm" mb={1.5}>
        <strong>Gopad</strong> is an open-source collaborative text editor
      ...
      <Text fontSize="sm" mb={1.5}>
        Built using go and TypeScript. See the{" "}
        <Link
          color="blue.600"
          fontWeight="semibold"
          href="https://github.com/pancakeswya/gopad"
          isExternal
        >
          GitHub repository
        </Link>{" "}
